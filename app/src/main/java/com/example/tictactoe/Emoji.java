...
public class Emoji extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (activePlayer) {
            Drawable img = ((Button) v).getContext().getResources().getDrawable(R.drawable.whoo);
            ((Button) v).setCompoundDrawablesWithIntrinsicBounds(img,null,null,null);
            // ((Button) v).setText("X");
            ((Button) v).setTextColor(Color.parseColor("#FFC34A"));
            gameState[gameStatePointer] = 0;
        } else {
            Drawable img = ((Button) v).getContext().getResources().getDrawable(R.drawable.star51);
            ((Button) v).setCompoundDrawablesWithIntrinsicBounds(img,null,null,null);
            // ((Button) v).setText("O");
    ...
    public void playAgain()
    {
        ...
        for(int i = 0; i< buttons.length; i++ ){
            ...
            Drawable img = (buttons[i]).getContext().getResources().getDrawable(R.drawable.transparent);
            (buttons[i]).setCompoundDrawablesWithIntrinsicBounds(img,null,null,null);
        }
    }
}